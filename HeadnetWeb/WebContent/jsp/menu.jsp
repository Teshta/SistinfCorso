...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><c:if test="${!empty USER.username}"><a href="#">Amici</a></c:if></li>
      <li><c:if test="${!empty USER.username}"><a href="${pageContext.servletContext.contextPath}/jsp/richiesteAmicizia.jsp">Richieste di amicizia</a></c:if></li>
    </ul>
  ...
  <c:if test="${!empty USER.username}"><form class="navbar-form navbar-left" action="${pageContext.servletContext.contextPath}/search" method="post">
    ...
    <input type="cognome" class="form-control" placeholder="Cognome" id="cognome" name="cognome" />
      ...
      <li><c:if test="${empty USER.username}"><a href="${pageContext.servletContext.contextPath}/jsp/registra.jsp"><span class="glyphicon glyphicon-user"></span> Sign Up</a></c:if></li>
      <li><c:if test="${empty USER.username}"><a href="${pageContext.servletContext.contextPath}/jsp/login.jsp"><span class="glyphicon glyphicon-log-in"></span> Login</a></c:if></li>
      <li><c:if test="${!empty USER.username}"><a href="${pageContext.servletContext.contextPath}/logout"><span class="glyphicon glyphicon-log-out"></span> Logout</a></c:if></li>
    </ul>
    </form>
  </div>
</nav>